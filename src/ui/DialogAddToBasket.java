...
public class DialogAddToBasket extends JDialog {
	...
	public DialogAddToBasket(Product product) {
				...
				btnAddProduct.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {						
						...
						int result =JOptionPane.showOptionDialog(null, "You item has been added to basket", "CAS-Item",
						    ...
						    options, options[0]);
						if(result == 0) {
							DailogBasket cartDailog = new DailogBasket();
	...
	private void addToCart() 
	{
		...
		cart.addBasketItem(selectedProduct, quantity);
	}
}
